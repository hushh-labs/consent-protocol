 ...
 * GET: Retrieve professional data (requires session token)
 * POST: Store professional data (requires consent token with vault.write.professional scope)
 *
 * 3-Layer Security:
...
export async function GET(request: NextRequest) {
  ...
  logSecurityEvent("VAULT_READ_SUCCESS", { domain: "professional", userId });
  return NextResponse.json({ domain: "professional", preferences: data });
}

// ============================================================================
// POST: Write professional data (requires consent token)
// ============================================================================
