// app/api/vault/food/preferences/route.ts

/**
 * Food Preferences API - Token-Enforced
 *
 * GET endpoint for reading food preferences with VAULT_OWNER token.
 * Proxies to Python backend /api/food/preferences
 */
...
export async function GET(request: NextRequest) {
  ...
  try {
    // Proxy to token-enforced backend endpoint (note: /api/food, not /api/vault/food)
